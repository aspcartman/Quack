...
DEVICE=attiny45
AVRDUDE = avrdude -c ftbb -P ft0 -p $(DEVICE) -B 1
...
COMPILE = avr-gcc -std=c99 -Wall -Os -Iusbdrv -I. -mmcu=$(DEVICE) -DF_CPU=12000000 -DDEBUG_LEVEL=0
...
fuse:
	$(AVRDUDE) -U hfuse:w:0xdd:m -U lfuse:w:0xff:m 
